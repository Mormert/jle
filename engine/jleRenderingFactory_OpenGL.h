...
public:
    ...
    [[nodiscard]] std::unique_ptr<jleQuadRenderingInterface>
    CreateQuadRendering() const override;

    [[nodiscard]] std::unique_ptr<jleTextRenderingInterface>
    CreateTextRendering() const override;
