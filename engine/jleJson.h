...
inline void
from_json(const nlohmann::json &j, jleJsonString &s)
{
    JLE_FROM_JSON_WITH_DEFAULT(j, s._string, "_string", "");
}

inline void
to_json(nlohmann::json &j, const jleJsonString &s)
{
    j["_string"] = s._string;
}
...
inline void
from_json(const nlohmann::json &j, jleJsonInt &i)
{
    JLE_FROM_JSON_WITH_DEFAULT(j, i._int, "_int", 0);
}

inline void
to_json(nlohmann::json &j, const jleJsonInt &i)
{
    j["_int"] = i._int;
}
...
inline void
from_json(const nlohmann::json &j, jleJsonFloat &f)
{
    JLE_FROM_JSON_WITH_DEFAULT(j, f._float, "_float", 0);
}

inline void
to_json(nlohmann::json &j, const jleJsonFloat &f)
{
    j["_float"] = f._float;
}