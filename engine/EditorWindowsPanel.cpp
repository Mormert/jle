...
namespace jle {
    ...
    void jle::EditorWindowsPanel::DockspaceUpdate(jleGameEngine &ge) {
    ...
    void EditorWindowsPanel::MenuButtonsUpdate(jleGameEngine &ge) {
        if (ImGui::BeginMenuBar()) {
            ...
            ImGui::Text("FPS: %4d, DT: %4f, Time: %4f", ge.status->GetFPS(), ge.status->GetDeltaFrameTime(),
